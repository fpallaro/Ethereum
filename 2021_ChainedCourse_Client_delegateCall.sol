...
contract ChainedCourseClient {
    ...
    function  getHelloWorld() public payable returns (string memory ) {
    ...
    function  fire(uint8 _x, uint8 _y) public returns (bool, uint8, string memory _error) {
